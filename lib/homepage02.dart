...
class hompage02 extends StatefulWidget {
  const hompage02({Key? key}) : super(key: key);

  @override
  State<hompage02> createState() => _hompage02State();
}

class _hompage02State extends State<hompage02> {
  @override
          ...
          child: Padding(
            ...
            child: Center(
              child: Container(
                ...
                child: Column(
                  children: [
                    Image.asset("Assets/onbording screen 03.png",height: 300,
